...
const docTemplate = `{
    ...
    "paths": {
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.PatchPartyRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/parties/{code}/attendees/{attendeeId}": {
            "delete": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.BeerDTO"
                        }
                    }
                ],
                "responses": {
